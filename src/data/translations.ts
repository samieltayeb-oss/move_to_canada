...
export const translations: Record<'en' | 'ar', TranslationDictionary> = {
  en: {
    ...
    hero: {
      ...
      familySummary: "Household Profile: 2 Adults • 3 Children (Ages 16, 11, 5) • Saudi Arabia → Canada",
  ...
  ar: {
    ...
    hero: {
      ...
      familySummary: "ملف العائلة: بالغان • 3 أبناء (أعمار 16، 11، 5 سنوات) • السعودية ← كندا",
