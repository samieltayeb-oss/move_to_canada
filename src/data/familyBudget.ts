...
export const familyBudgetScenarios: Record<'STARTING_CAREFULLY' | 'COMFORTABLE' | 'PREMIUM', FamilyBudgetScenario> = {
  STARTING_CAREFULLY: {
    ...
    groceryStrategy: 'Costco Bulk + Superstore / Walmart Specials ($1,310/mo)',
    schoolType: 'CBE Public School Catchment (Free tuition)',
    totalMonthlyCAD: 5310,
    totalAnnualCAD: 63720,
    items: [
      ...
      { category: 'Groceries & Household (Halal)', arabicCategory: 'المواد الغذائية والتموينية (حلال)', monthlyCAD: 1310, annualCAD: 15720, weeklyCAD: 302, fixedOrVariable: 'Variable', notes: 'Costco + Superstore Value Plan' },
  ...
  COMFORTABLE: {
    ...
    description: 'Standard executive lifestyle: 4-bedroom detached home with double garage, Balanced Family halal grocery model, AWD family SUV, Islamic schooling (CIS) for children.',
    housingType: '4-Bedroom Detached Single-Family Home ($2,950/mo)',
    vehicleType: 'Late-model Toyota Highlander AWD / Sienna Hybrid ($450/mo lease/finance)',
    groceryStrategy: 'Balanced Family: Costco + Halal Butcher + Fresh Produce ($1,630/mo)',
    schoolType: 'Calgary Islamic School (CIS) for 2 school-age kids ($410/mo)',
    totalMonthlyCAD: 7540,
    totalAnnualCAD: 90480,
    items: [
      { category: 'Housing (Rent)', arabicCategory: 'إيجار السكن', monthlyCAD: 2950, annualCAD: 35400, weeklyCAD: 681, fixedOrVariable: 'Fixed', notes: '4-Bed detached house with garage' },
      ...
      { category: 'Groceries & Household (Halal)', arabicCategory: 'المواد الغذائية والتموينية (حلال)', monthlyCAD: 1630, annualCAD: 19560, weeklyCAD: 376, fixedOrVariable: 'Variable', notes: 'Balanced family plan' },
      ...
      { category: 'Calgary Islamic School (CIS) Fees', arabicCategory: 'رسوم المدرسة الإسلامية (CIS طفلين)', monthlyCAD: 410, annualCAD: 4920, weeklyCAD: 95, fixedOrVariable: 'Fixed', notes: '~$2,460/yr per student (Akram Jomaa)' },
  ...
  PREMIUM: {
    ...
    groceryStrategy: 'Premium Organic + Fresh Halal Butcher ($2,080/mo)',
    schoolType: 'Islamic Alternative or Private Academy ($650/mo)',
    totalMonthlyCAD: 11440,
    totalAnnualCAD: 137280,
    items: [
      ...
      { category: 'Groceries & Household (Halal)', arabicCategory: 'المواد الغذائية والتموينية (حلال)', monthlyCAD: 2080, annualCAD: 24960, weeklyCAD: 480, fixedOrVariable: 'Variable', notes: 'Premium organic & halal meats' },
